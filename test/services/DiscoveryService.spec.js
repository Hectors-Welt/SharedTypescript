...
describe("DiscoveryService", () => {
    describe("MongoDbSettings", () => {
        const mongoDbSettings = new MongoDbSettings_1.default({
            host: "mongodb",
            port: 27107,
            username: null,
            password: null
        ...
        it("should resolve settings", (done) => {
            ...
            const service = new DiscoveryService_1.default(discoveryServiceHost, discoveryServicePort);
    ...
    describe("EventStoreSettings", () => {
        const eventStoreSettings = new EventStoreSettings_1.default({
            host: "eventstore",
            tcpPort: 1113,
            httpPort: 2113,
            username: null,
