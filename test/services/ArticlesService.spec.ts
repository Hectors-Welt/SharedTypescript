...
describe('ArticlesService', () => {
  ...
  describe('getArticles', () => {
    it('should get data', async () => {
      this.nock.get('/getArticles').reply(200, {});
    ...
    it('should reject when data not available', async () => {
      this.nock.get('/getArticles').reply(404);
  ...
  describe('lookupBookingInformation', () => {
    it('should get data', async () => {
      this.nock.get('/getBookingInformationForArticleId/123/AndCustomerId/122').reply(200, {});
    ...
    it('should reject when data not available', async () => {
      this.nock.get('/getBookingInformationForArticleId/123/AndCustomerId/122').reply(404);
  ...
  describe('bookArticle', () => {
    it('should get data', async () => {
      this.nock.post('/bookArticle').reply(200, {});
    ...
    it('should reject when data not available', async () => {
      this.nock.post('/bookArticle').reply(404);
