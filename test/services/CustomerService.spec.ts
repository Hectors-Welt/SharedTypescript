...
describe('CustomerService', () => {
  ...
  describe('findDoublets', () => {
    it('should get data', async () => {
      this.nock
      .post('/findDoublets', { name: 'test', birthday: '10-10-1990' })
      .reply(200, {});
  ...
  describe('getCustomerByCustomerId', () => {
    it('should get data', async () => {
      this.nock
      .get('/getCustomerByCustomerId/123')
      .reply(200, {});
  ...
  describe('getProfilePicture', () => {
    it('should get data', async () => {
      this.nock
      .get('/customer/123/profilePicture')
      .reply(200, {});
