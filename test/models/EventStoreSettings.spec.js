...
describe("EventStoreSettings", function () {
    describe("constructor validation", function () {
        ...
        it("should throw error when invalid data passed in", function () {
            chai_1.expect(() => new EventStoreSettings_1.default({})).to.throw(validationError);
        });
        it("should succeed with valid data passed in", function () {
            chai_1.expect(() => new EventStoreSettings_1.default({ host: "host", tcpPort: 12345, httpPort: 54321 })).to.not.throw(validationError);
        });
    });
});
