...
describe("MongoDbSettings", function () {
    describe("constructor validation", function () {
        ...
        it("should throw error when invalid data passed in", function () {
            chai_1.expect(() => new MongoDbSettings_1.default({})).to.throw(validationError);
        });
        it("should succeed with valid data passed in", function () {
            chai_1.expect(() => new MongoDbSettings_1.default({ host: "host", port: 12345 })).to.not.throw(validationError);
        });
    });
    describe("getConnectionUri", function () {
        it("should return authSource=admin when credentials provided", function () {
            ...
            const settings = new MongoDbSettings_1.default({
                host: host,
                port: port,
                username: username,
                password: password
