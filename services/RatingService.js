...
class RatingService {
    ...
    addRatingResult(ratingResult) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ApiClient_1.ApiClient.POST(`${this.baseUrl}/ratings`, ratingResult);
            }
            catch (err) {
    ...
    getRatings(referenceId, ratingItemType) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ApiClient_1.ApiClient.GET(`${this.baseUrl}/ratings/${referenceId}/${ratingItemType}`);
            }
            catch (err) {
