...
export class MembershipService implements IMembershipService {
  ...
  async simulateContracts(command: CreateContractsCommand): Promise<any> {
    try {
      return await ApiClient.POST(`${this.baseUrl}/commands/simulateContracts`, command, null, true);
    } catch (err) {
      return {
        success: false,
