...
class CourseManagementService {
    ...
    getAppointment(appointmentId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ApiClient_1.ApiClient.GET(`${this.baseUrl}/appointments/${appointmentId}`);
            }
            catch (err) {
    ...
    cancelAppointment(appointmentId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ApiClient_1.ApiClient.DELETE(`${this.baseUrl}/appointments/${appointmentId}`);
            }
            catch (err) {
